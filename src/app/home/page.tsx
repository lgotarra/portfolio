  ...
  return (
    <main className="mainPage">
      <section className="text-center max-w-2xl mx-auto space-y-4">
        ...
        <h2 className="text-5xl font-bold text-primary">Laura Gotarra</h2>
        ...
        <p className="text-md">
          ...
          environments where adaptability and good communication are key.
          I&apos;m also passionate about machine learning and audio/image
          processing, always eager to explore new technologies and expand my
          skill set.
        </p>
      </section>
    </main>
